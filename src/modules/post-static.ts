      ...
      <header class="post-header">
        ...
        <div class="post-meta">
          ...
          ${post.frontmatter.tags ? `
            <div class="tags">
              ${post.frontmatter.tags.map((tag: string) => `<a href="../tags/${encodeURIComponent(tag.toLowerCase())}.html" class="tag">${tag}</a>`).join("")}
            </div>
          ` : ""}
        </div>
                ...
                <div class="update-header-main">
                  ...
                  <div class="update-meta">
                    ...
                    ${update.frontmatter.tags ? `
                      <div class="tags">
                        ${update.frontmatter.tags.map((tag: string) => `<a href="../tags/${encodeURIComponent(tag.toLowerCase())}.html" class="tag">${tag}</a>`).join("")}
                      </div>
                    ` : ""}
                  </div>
                </div>
